...
from Prescriptions.models import Prescription  # Assuming you have a Prescription model
from Medicines.models import Medicine  # Assuming you have a Medicine model
